...
f_prediction_with_NN_api_new <- function(forecastData, histData, pred_model){
  ...
  # created 31.10.2020: 
  # 5 11 2020: test for empty model
  ...
  prediction=list(date=forecastData$dateInfo$date,predicted_consumption=pred_consumption, clust_pred=clust_pred)
  return(prediction)
}